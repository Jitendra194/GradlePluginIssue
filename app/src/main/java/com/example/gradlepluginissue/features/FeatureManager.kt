...
import com.example.gradlepluginissue.appComponent
...
private fun FeatureManager.selectFeature(featureName: FeatureName) = when (featureName) {
    FeatureName.ModuleFeature -> injectFeature<ModuleFeature, ModuleFeature.Dependencies>(
        appComponent.moduleFeature, featureName)
}
...
internal class FeatureManagerImpl(private val application: BaseApplicationClass) :
    FeatureManager {
